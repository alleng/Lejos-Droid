...
public class LeJOSDroid extends Activity {
    ...
    // static final String START_MESSAGE =
    // "Please make sure you NXT is on and both it and your Android handset have bluetooth enabled";
    ...
    private void setupRCNavigationControl(final LeJOSDroid leJOSDroid) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent RCNavigationControl = new Intent(leJOSDroid,
                        lejos.android.RCNavigationControl.class);
